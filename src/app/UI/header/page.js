...
<section className="main bg-cyan-50  h-full py-6 ">         
 <div className="flex justify-around">
    <div className="mt-10 py-32 ml-4 ">
     ...
     <button className="bg-orange-600 py-2  px-6 mt-10 ml-4 rounded-lg shadow-2xl">
     Contact me</button>
    ...
    <div className="flex content-center items-center rounded-full shadow-2xl">
